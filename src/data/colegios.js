export const COLEGIOS = [
  { value: "Liceo San José del Carmen", label: "Liceo San José del Carmen" },
  { value: "Escuela de Lihueimo", label: "Escuela de Lihueimo" },
  { value: "Escuela de Valle Hermoso", label: "Escuela de Valle Hermoso" },
